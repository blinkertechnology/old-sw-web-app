<template>
  ...
  <kaiui-text text="2.2	SORS reserves the right to request written confirmation, or to seek additional documents or information, regarding your authority to agree to these Terms of Use."/>
  <kaiui-text text="2.3	SORS reserves the right to refuse access to any users to our Website or the Services if SORS, in its absolute discretion, deems such refusal necessary."/>
  ...
  <kaiui-text text="2.6	If you do not agree to these Terms of Use, you must not use the Website or our Services."/>
  ...
  <kaiui-text text="(b)	you consent and agree to comply with our Acceptable Use policy (see paragraph 5 below for further details)."/>
  ...
  <kaiui-text text="3.8	(a)	You are solely responsible for activity that occurs in your Account or Wallet.
  ...
  <kaiui-text text="(j)	use data collected from the Website, our Services, your Account, your Wallet, or the Platform to contact individuals, companies or other persons or entities;"/>
  <kaiui-text text="(k)	make the Website available to any third party through a private computer network;
  ...
  <kaiui-text text="(n)	transmit any material that is unlawful, disruptive, threatening, profane, abusive, harassing, embarrassing, tortuous, defamatory, obscene, libelous, is hateful or racially or ethnically offensive; 
  ...
  <kaiui-text text="5.2	You must ensure that all the information you supply to us:
  ...
  <kaiui-text text="6.6	SORS does not guarantee the correct functioning of the Platform in the event of the installation or use of programs or applications that do not conform to Platform specifications and technical standards.  
  ...
  <kaiui-text text="7.3	You represent and warrant that:
  ...
  <kaiui-text text="9.1	You should educate yourself in respect of all the legal norms and technical constraints relating to the proof-of-stake and proof-of-work blockchains, or other cryptographic proof concepts. 
  ...
  <kaiui-text text="12.1	Our Privacy Policy can be reviewed here [link] [TDW Note: Please insert] and forms part of these Terms of Use on which you may access and use our Website, the Platform and our Service.
  ...
  <kaiui-text text="12.3	We use cookies on our Website. We also use cookies to track the way you prefer to view our Website. By accepting these Terms of Use you also give consent to our use of cookies for this purpose. More information about cookies is contained in our Privacy Policy. 
  ...
  <kaiui-text text="15.1	Subject to paragraph 15.13, SORS disclaims all liability to the maximum extent permitted by law, and SORS assumes no responsibility, for losses to you or any other person arising from:
  ...
  <kaiui-text text="15.6	Any disclaimer of liability includes all representations or warranties. All representations or warranties, whether contractual or non-contractual, and all warranties, conditions, terms, undertakings and obligations implied by statute, common law, custom, trade usage, course of dealing or otherwise (including implied undertakings of satisfactory quality, conformity with description and reasonable fitness for purpose) are excluded to the maximum extent permitted by law."/>

  <kaiui-text text="15.7	Only one claim may be brought against us (including our employees, officers or consultants) arising from one act or omission. One act or omission includes one series of related acts or omissions, the same act or omission in a series of related matters or similar acts or omissions in a series of related matters, and includes all claims arising from any one matter.
  ...
  <kaiui-text text="15.10	If SORS has joint and several liability to you with another party SORS will only be liable to pay you the proportion which is found to be fairly and reasonably due to SORS’s fault.  SORS will not be liable to pay you the proportion which is due to the fault of another party for which such other party would otherwise be liable.  
  ...
  <kaiui-text text="15.12	In considering whether other parties may be liable to you, no account is to be taken of any inability on your part to enforce remedies against another party by reason of causes of action against that party becoming time-barred, or the party’s lack of means or the party’s reliance on exclusions or limitations of liability or that the other party has ceased to exist.

  15.13	No oral or written information given by SORS creates a warranty or in any way increase the scope of SORS liability."/>
  <kaiui-text text="15.14	The exclusions and limitations of liability in these Terms of Use do not affect SORS’s liability:
  ...
  <kaiui-text text="16.2	SORS will be entitled to recover from you all expenses SORS reasonably incurs in connection with an indemnified claim, and all such expenses will be payable on demand.
  ...
  <kaiui-text text="19.	Termination and suspension
  ...
  <kaiui-text text="19.2	SORS may suspend the provision of the Website, the Platform or Services or terminate your Account or Wallet at any time, with or without cause, and with or without notice."/> 
  ...
  <kaiui-text text="20.1	Upon termination of these Terms of Use:
  ...
  <kaiui-text text="21.2	The rights, powers and remedies provided in these Terms of Use are (except as expressly provided) cumulative and not exclusive of any rights, powers and remedies provided by law, or otherwise."/>
  ...
  <kaiui-text text="21.4	If the validity or enforceability of any provision of these Terms of Use is in any way limited by any applicable law, that provision will be valid and enforceable to the fullest extent permitted by such law.  The invalidity or unenforceability of any such provision does not affect the validity or enforceability of any other provision."/>

  <kaiui-text text="21.5	The failure to exercise, or delay in exercising, a right, power or remedy provided by these Terms of Use or by law does not constitute a waiver of that right, power or remedy. If SORS waives a breach of any provision of these Terms of Use, this does not operate as a waiver of a subsequent breach of that provision, or as a waiver of a breach of any other provision."/>

  <kaiui-text text="21.6	The exercise of the parties’ rights under these Terms of Use is not subject to the consent of any third party."/>

  <kaiui-text text="21.7	These Terms of Use are for SORS’s benefit and your benefit, and are not intended to benefit or be enforceable by any third party."/>

  <kaiui-text text=" 21.8	These Terms of Use comprise the entire understanding and agreements between you and SORS as to its subject matter, and supersedes any and all prior discussions, agreements and understandings of any kind relating to its subject matter (including any prior versions of these Terms of Use).
  ...
  <kaiui-text text="21.12	Communications between you and SORS use electronic means, whether made via the Website, the Platform or sent via electronic mail, or whether SORS posts notices on the Website or the Platform. For contractual purposes, you:
