<template>
  ...
  (i)	you are not on any of the sanctions lists published and maintained by the United Nations, European Union, any EU country, UK Treasury or US Office of Foreign Assets Control." />
        ...
        <kaiui-text
          text="2.2	SORS reserves the right to request written confirmation, or to seek additional documents or information, regarding your authority to agree to these Terms of Use." />
        <kaiui-text
          text="2.3	SORS reserves the right to refuse access to any users to our Website or the Services if SORS, in its absolute discretion, deems such refusal necessary." />
        <kaiui-text text="2.4	You represent and warrant that neither you nor anyone authorised by you:
  ...
  (c)	have been refused Services by SORS in the past." />
        <kaiui-text text="2.5	Your application to create an Account and a Wallet constitutes:
  ...
  (c)	your undertaking to us to comply with them." />
        <kaiui-text
          text="2.6	If you do not agree to these Terms of Use, you must not use the Website or our Services." />
        <kaiui-text text="2.7	You must expressly agree to these Terms of Use to:
  ...
  (e)	use our Services." />
        <kaiui-text text="By visiting our Website, creating an Account and a Wallet, accessing the Platform, using our Services or agreeing to these Terms of Use:

  (a)	you also agree and consent to our Privacy Policy. Our Privacy Policy can be reviewed" />
        <kaiui-text
          text="(b)	you consent and agree to comply with our Acceptable Use policy (see paragraph 5 below for further details)." />
        <!-- <kaiui-text text="2.9	We recommend you print a copy of these Terms of Use for future reference.
  ...
  3.7	SORS reserves the right to refuse registration of, suspend access to, or cancel an Account or a Wallet in its sole discretion. " />
        <kaiui-text
          text="3.8	(a)	You are solely responsible for activity that occurs in your Account or Wallet.
  ...
  (i)	use data collected from the Website, our Services, your Account, your Wallet, or the Platform for any direct marketing activity (including email marketing, SMS marketing, telemarketing or direct mailing); " />
        <kaiui-text
          text="(j)	use data collected from the Website, our Services, your Account, your Wallet, or the Platform to contact individuals, companies or other persons or entities;" />
        <kaiui-text
          text="(k)	make the Website available to any third party through a private computer network;
  ...
  (m)	use the Website, our Services, your Account, your Wallet, or the Platform in a manner prohibited by any laws or regulations which apply to the use of the Website, our Services, your Account, your Wallet, or the Platform;" />
        <kaiui-text
          text="(n)	transmit any material that is unlawful, disruptive, threatening, profane, abusive, harassing, embarrassing, tortuous, defamatory, obscene, libelous, is hateful or racially or ethnically offensive; 
  ...
  (p)	use or access the Website, our Services, your Account, your Wallet, or the Platform in order to build a similar or competitive product or service or disclose to any third party any benchmarking or comparative study involving the Services." />
        <kaiui-text
          text="5.2	You must ensure that all the information you supply to us:
  ...
  (d)	remove or destroy any copyright notices or other proprietary markings contained on or in the Services or the Copyrighted Content." />
        <kaiui-text
          text="6.6	SORS does not guarantee the correct functioning of the Platform in the event of the installation or use of programs or applications that do not conform to Platform specifications and technical standards.  
  ...
  SORS will use reasonable endeavours to give you reasonable notice of any suspension or withdrawal to the extent that circumstances or applicable laws permit.  You will not be entitled to any compensation or other payment upon the discontinuance, suspension, withdrawal or alteration of the Website or the Platform." />
        <kaiui-text text="6.8	SORS may make obsolete a prior version of the Website and Platform at any time. 
  ...
  7.2	Only certain Cryptocurrencies are supported by our Services. SORS may update the supported Cryptocurrencies from time to time, and will announce such update on the Website and the Platform. SORS will not be responsible to ensure you are informed of the update. You are responsible to keep yourself informed. SORS will not be liable for any losses if you transfer unsupported Cryptocurrencies into the Wallet." />
        <kaiui-text
          text="7.3	You represent and warrant that:
  ...
  (c)	you have consulted or have been given the time and opportunity to consult your own legal, financial and tax advisors in respect of your use of your Account, Wallet, our Services and in respect of any transactions involving Cryptocurrencies." />
        ...
        <kaiui-text text="7.4	When transferring your Cryptocurrencies from your Wallet, you are responsible for checking and confirming that the recipient wallet address or public key information:
  ...
  9.	Risk" />
        ...
        <kaiui-text
          text="9.1	You should educate yourself in respect of all the legal norms and technical constraints relating to the proof-of-stake and proof-of-work blockchains, or other cryptographic proof concepts. 
  ...
  11.6	We reserve the right to restrict access to areas of our Website, or our whole Website, at our discretion. You must not circumvent or bypass, or attempt to circumvent or bypass, any access restriction measures on our Website." />
        <kaiui-text
          text="12.1	Our Privacy Policy can be reviewed here [link] [TDW Note: Please insert] and forms part of these Terms of Use on which you may access and use our Website, the Platform and our Service.
  ...
  12.2	You agree that SORS may collect and use personal data which you provide when registering on the Website or through the Platform. The use of personal data collected by us will be limited to granting you access to the Platform, the Website and our Services. You agree we can share your personal data with any external service provider, agents, advisors and consultants for the purpose of creating your Account, Wallet and granting you access to the Platform, the Website and our Services." />
        ...
        <kaiui-text
          text="12.3	We use cookies on our Website. We also use cookies to track the way you prefer to view our Website. By accepting these Terms of Use you also give consent to our use of cookies for this purpose. More information about cookies is contained in our Privacy Policy. 
  ...
  14.4	No oral or written information or advice given by SORS creates a warranty or in any way increase the scope of its liability." />
        ...
        <kaiui-text
          text="14.5	SORS does not, and does not intend to, market to, sell to, induce, solicit, or advise any person in respect of any purchase, subscription or investment (or any related offer) in securities, Cryptocurrencies, tokens, non-fungible tokens (NFTs) or any physical or virtual assets (whether described as investment opportunities, or otherwise). None of the information made available by SORS constitutes an invitation, offer, opinion or recommendation to purchase, subscribe, invest in or participate in any securities, structured products, Cryptocurrencies, non-fungible tokens (NFTs) or any physical or virtual assets (whether described as investment opportunities, or otherwise)." />
        <kaiui-text text="14.6	Your use of the Website, the Platform or Services, or any information, material or content obtained through our Website, the Platform or Services, is at your own risk and discretion.
  
  15.	Liability" />

        <kaiui-text
          text="15.1	Subject to paragraph 15.13, SORS disclaims all liability to the maximum extent permitted by law, and SORS assumes no responsibility, for losses to you or any other person arising from:
  ...
  15.5	Except to the extent that claims cannot be excluded or restricted by law, no claims arising out of or in connection with these Terms of Use may be brought by you personally against any of SORS’s employees, officers, advisors, consultants, external service providers or other representatives involved in the performance of the relevant obligations." />
        ...
        <kaiui-text
          text="15.6	Any disclaimer of liability includes all representations or warranties. All representations or warranties, whether contractual or non-contractual, and all warranties, conditions, terms, undertakings and obligations implied by statute, common law, custom, trade usage, course of dealing or otherwise (including implied undertakings of satisfactory quality, conformity with description and reasonable fitness for purpose) are excluded to the maximum extent permitted by law." />

        <kaiui-text
          text="15.7	Only one claim may be brought against us (including our employees, officers or consultants) arising from one act or omission. One act or omission includes one series of related acts or omissions, the same act or omission in a series of related matters or similar acts or omissions in a series of related matters, and includes all claims arising from any one matter.
  ...
  15.9	Where a limitation of liability applies in whatever amount, the limitation applies to the entire performance of services by SORS, and there will not be separate aggregate limits of liability applicable to you, any group company to which you belong, and all individuals nominated by a corporate user." />
        ...
        <kaiui-text
          text="15.10	If SORS has joint and several liability to you with another party SORS will only be liable to pay you the proportion which is found to be fairly and reasonably due to SORS’s fault.  SORS will not be liable to pay you the proportion which is due to the fault of another party for which such other party would otherwise be liable.  
  ...
  (b)	SORS had brought proceedings or made a claim against that other party under the Civil Liability (Contribution) Ordinance (Cap. 377) or similar law under any other relevant jurisdiction." />
        ...
        <kaiui-text
          text="15.12	In considering whether other parties may be liable to you, no account is to be taken of any inability on your part to enforce remedies against another party by reason of causes of action against that party becoming time-barred, or the party’s lack of means or the party’s reliance on exclusions or limitations of liability or that the other party has ceased to exist.

  15.13	No oral or written information given by SORS creates a warranty or in any way increase the scope of SORS liability." />
        <kaiui-text
          text="15.14	The exclusions and limitations of liability in these Terms of Use do not affect SORS’s liability:
  ...
  (g)	any acts or omissions performed by you or your representatives" />
        ...
        <kaiui-text
          text="16.2	SORS will be entitled to recover from you all expenses SORS reasonably incurs in connection with an indemnified claim, and all such expenses will be payable on demand.
  ...
  (n)	you suffer an insolvency or bankruptcy event." />
        <kaiui-text
          text="19.	Termination and suspension
  ...
  19.1	You can stop using the Website, the Platform or Services at any time and you may delete your Account or Wallet by sending an email to [email address]. Upon deletion of your Account or Wallet, all specific Account information will be deleted. However, domain names and a log-register attributable to each deleted Account will be kept for archival and administrative purposes. SORS may also use unidentifiable, aggregated information originating from deleted Accounts in its general business operations. [TDW Note: Client to confirm.]" />
        ...
        <kaiui-text
          text="19.2	SORS may suspend the provision of the Website, the Platform or Services or terminate your Account or Wallet at any time, with or without cause, and with or without notice." />

        <kaiui-text text="19.3	Without prejudice to paragraph 19.2, SORS may suspend or terminate your Account or Wallet if you are in breach of these Terms of Use, or if your use of the Website or Services would cause or risk causing legal liabilities of any kind, or otherwise disrupt others use of the Website or Services. 

  20.	Effect of termination" />

        <kaiui-text
          text="20.1	Upon termination of these Terms of Use:
  ...
  20.3	The termination of these Terms of Use is without prejudice to any other rights which have already accrued to SORS and will not operate to affect such provisions of these Terms of Use as in accordance with their terms are expressed to operate or to have effect thereafter." />
        <kaiui-text text="21.	General provisions" />

        <kaiui-text text="21.1	You may not assign any of your rights under these Terms of Use." />

        <kaiui-text
          text="21.2	The rights, powers and remedies provided in these Terms of Use are (except as expressly provided) cumulative and not exclusive of any rights, powers and remedies provided by law, or otherwise." />

        <kaiui-text text="21.3 SORS subcontract: 
  ...
  (c)	the Account and Wallet creation function to [Arkane BV]." />
        ...
        <kaiui-text
          text="21.4	If the validity or enforceability of any provision of these Terms of Use is in any way limited by any applicable law, that provision will be valid and enforceable to the fullest extent permitted by such law.  The invalidity or unenforceability of any such provision does not affect the validity or enforceability of any other provision." />

        <kaiui-text
          text="21.5	The failure to exercise, or delay in exercising, a right, power or remedy provided by these Terms of Use or by law does not constitute a waiver of that right, power or remedy. If SORS waives a breach of any provision of these Terms of Use, this does not operate as a waiver of a subsequent breach of that provision, or as a waiver of a breach of any other provision." />

        <kaiui-text
          text="21.6	The exercise of the parties’ rights under these Terms of Use is not subject to the consent of any third party." />

        <kaiui-text
          text="21.7	These Terms of Use are for SORS’s benefit and your benefit, and are not intended to benefit or be enforceable by any third party." />

        <kaiui-text
          text=" 21.8	These Terms of Use comprise the entire understanding and agreements between you and SORS as to its subject matter, and supersedes any and all prior discussions, agreements and understandings of any kind relating to its subject matter (including any prior versions of these Terms of Use).
  ...
  21.10	Terms that are defined in the Companies Ordinance (Chapter 622, Laws of Hong Kong) have the same meaning in these Terms of Use, unless otherwise defined in these Terms of Use" />
        ...
        <kaiui-text
          text="21.12	Communications between you and SORS use electronic means, whether made via the Website, the Platform or sent via electronic mail, or whether SORS posts notices on the Website or the Platform. For contractual purposes, you:
  ...
  22.1	These Terms of Use, their subject matter and their formation (and any non-contractual disputes or claims) are governed by and construed in accordance with the laws of Hong Kong." />
        <kaiui-text
          text="22.2	Any dispute, controversy, difference or claim (including non-contractual disputes or claims) arising out of or relating to these Terms of Use, including the existence, validity, interpretation, performance, breach or termination thereof or any dispute regarding non-contractual obligations arising out of or relating to it shall be referred to and finally resolved by arbitration administered by the Hong Kong International Arbitration Centre (HKIAC) under the HKIAC Administered Arbitration Rules in force when the Notice of Arbitration is submitted. The law of this arbitration clause shall be Hong Kong law). The seat of arbitration shall be Hong Kong. The number of arbitrators shall be one. The arbitration proceedings shall be conducted in English." />
        <kaiui-text
          text="Please email. if you have any questions or concerns about these Terms of Use or our Website." /> -->

        <kaiui-checkbox primaryText="I have read and agreed" secondaryText="on the Terms & Coditions" class="tandc"
          v-on:softCenter="showDialogs" id="myCheck" />

        <kaiui-button v-bind:softkeys="softkeysPhone" v-on:softRight="phoneButtonSoftRightClicked"
          v-on:softCenter="phoneButtonSoftCenterClicked" v-on:softLeft="phoneButtonSoftleftClicked"
          title="Agree/Connect" />
...
export default {
  ...
  data: () => ({
    softkeysPhone: { left: "FAQ", center: "Agree" },
    agree: false,
    softkeys: {
      left: "",
      center: "",
  ...
  methods: {
    ...
    phoneButtonSoftCenterClicked() {
      if (this.agree === false) {
        this.$toastr.e("Please agree on Terms & Conditions!");
        return false;
      }
      this.$cookie.set("TANDC", "hide", { expires: "90D" });
