export default {
    ...
    genericErrorTitle: 'Đã xảy ra sự cố.',
    genericError: 'đã xảy ra lỗi, vui lòng thử lại sau.',

    loggedOut: 'Bạn đã đăng xuất, vui lòng đăng nhập lại.',
    offline: {
        title: 'bạn đang offline',
        text: 'Có vẻ như có vấn đề với kết nối của bạn. Vui lòng kiểm tra kết nối mạng của bạn.',
        refresh: 'Làm mới'
    },

    wallets: { 
        bitcoin: 'Wallets Bitcoin: Ví Bitcoin',
        matic: 'Wallets Matic: Ví Matic',
    },
    ...
    pages: {
        ...
        login: {
            title: 'đăng nhập',
            instructions1: 'Sorted Wallet sẽ gửi cho bạn mã một lần để xác minh số điện thoại của bạn.',
            instructions2: 'Nhập mã gồm 6 chữ số đã được gửi đến {phone}',
        },

        setupPIN: {
            title: 'Tạo mã pin của bạn',
            instructions1: 'Hãy ghi nhớ nó và giữ nó an toàn cho các giao dịch ví trong tương lai.',
            submit: 'Gửi đi',
            pinInput: 'Pin',
            confirmPinInput: 'xác nhận pin',
            errors: {
                required: 'Vui lòng nhập mã pin số.',
                match: 'Mã pin đã nhập không khớp',
        ...
        homepage: {
            intro: {
                ...
                sub: 'Đăng nhập hoặc Đăng ký để tiếp tục.',
            },
            emailLogin: 'E-mail & Mật khẩu',
            phoneLogin: 'Số điện thoại'
        },
        ...
        dashboard: {
            ...
            share: 'chia sẻ địa chỉ ví',
            shareEmail: 'E-mail',
            shareMessage: 'Thông điệp',
        },

        makeTransaction: {
            title: 'thực hiện giao dịch',
            upload: 'Tải lên hình ảnh (Mã QR)',
            scan: 'Quét QR (Địa chỉ ví)',
            destination: 'Địa chỉ ví đích',
            amount: 'số lượng',
            pin: 'Pin Code',
            submit: 'Gửi đi',
        },
    ...
    tac: {
        ...
        error: 'Vui lòng đồng ý với các điều khoản và điều kiện',

        confirm: {
            primary: 'Tôi đã đọc và đồng ý',
            secondary: 'đến các Điều khoản & Điều kiện',
        },
